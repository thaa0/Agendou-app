...
"[project]/components/time-input-configurator.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function TimeInputConfigurator() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TimeInputConfigurator.useEffect": ()=>{
            // Configura inputs existentes
            const configureTimeInputs = {
                "TimeInputConfigurator.useEffect.configureTimeInputs": ()=>{
                    document.querySelectorAll('input[type="time"]').forEach({
                        "TimeInputConfigurator.useEffect.configureTimeInputs": (input)=>{
            ...
            const observer = new MutationObserver({
                "TimeInputConfigurator.useEffect": (mutations)=>{
                    mutations.forEach({
                        "TimeInputConfigurator.useEffect": (mutation)=>{
                            mutation.addedNodes.forEach({
                                "TimeInputConfigurator.useEffect": (node)=>{
                                    if (node.nodeType === 1) {
                                        const element = node;
                                        ...
                                        if (element.querySelectorAll) {
                                            element.querySelectorAll('input[type="time"]').forEach({
                                                "TimeInputConfigurator.useEffect": (input)=>{
                                                    input.setAttribute('lang', 'pt-BR');
                                                }
                                            }["TimeInputConfigurator.useEffect"]);
                                        }
...
_s(TimeInputConfigurator, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = TimeInputConfigurator;
var _c;
__turbopack_context__.k.register(_c, "TimeInputConfigurator");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_3a1e0a42._.js.map